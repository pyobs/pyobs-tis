...
class PropertyPanel(QtWidgets.QGroupBox):
    ...
    checkbox, everything else (enums/buttons/strings) is shown read-only, since the tcam property
    type strings aren't reliably decodable without the SDK docs at hand."""
